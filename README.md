# Parking Slot Prediction — San Diego
...
Made some charts to see what the data was telling us (turns out Saturdays have the highest long-stay rates, and almost nobody pays for parking on Sundays). Then trained two models — Random Forest and XGBoost — to make the actual predictions.
 
**Step 5 — Checking how well it worked**
Looked at accuracy, precision, recall, and which features mattered most. Also built a function where you can plug in a time, location, and price, and get a prediction back.
...
XGBoost edges out slightly overall.
